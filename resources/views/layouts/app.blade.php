...
<script src="{{ asset('js/script.js') }}" defer></script>
  ...
  <style>
    nav { background-color: #f6f0ea; }
    .nav-link { color: #4b1f0e !important; font-weight: 600; transition: all 0.2s ease; }
    .nav-link:hover { color: #a0522d !important; border-bottom: 3px solid #a0522d; padding-bottom: 2px; }
    .profile-icon {
      color: white; background-color: #4b1f0e; border-radius: 50%;
      width: 35px; height: 35px; display: flex; justify-content: center; align-items: center;
      font-size: 18px; margin-right: 5px;
    }
    .profile-section { display: flex; align-items: center; margin-left: auto; }
    .profile-section .dropdown-menu { box-shadow: 0 4px 10px rgba(0,0,0,0.15); border-radius: 8px; padding: 10px; }
    .profile-section .btn-danger { font-size: 0.85rem; }
    @media (max-width: 768px) {
      .navbar-nav { text-align: center; }
      .profile-section { justify-content: center !important; margin-top: 10px; }
    }
  </style>
</head>
<body>
