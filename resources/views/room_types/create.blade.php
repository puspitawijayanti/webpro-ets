...
<div class="container mt-5 mb-4">
  <div class="card shadow-sm border-0 mx-auto p-4" style="max-width: 600px; background-color: #faf8f6;">
    <h3 class="text-center fw-bold text-brown mb-4">Add Room Type</h3>
    ...
    <form action="{{ route('room-types.store') }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="name" class="form-control border-brown rounded-pill px-3" required>
      </div>

      <div class="mb-3">
        <label class="form-label text-brown fw-semibold">Description</label>
        <textarea name="description" class="form-control border-brown rounded-4 px-3" rows="4"></textarea>
      </div>
